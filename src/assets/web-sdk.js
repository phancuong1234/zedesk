...
!function(e, t) {
    ...
    var r = ge(n.$("schedules").getValue(), e.$("departments").getKeys());
    if (e.$("account").$("departments_migrated$bool").getValue()) {
    var s = e.$("dg_mappings").getValue();
    r = Object.keys(r).reduce(function(e, t) {
    t in s ? e[s[t].group_id$int] = r[t] : e[t] = r[t];
    return e;
    }, {});
    }
    o.department_schedule = r;
    }
    return o;
    }
    }
